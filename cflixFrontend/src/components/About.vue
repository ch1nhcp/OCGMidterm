<template>
  <div>
    ...
    <section
      ...
      :style="{
        backgroundImage: src = 'https://i.imgur.com/LtqwxqQ.png',
      }"
    >
      <h2 class="l-text2 t-center text-center mt-5 h1 font-weight-bold">About</h2>
    </section>
        ...
        <div class="row">
          <div class="col-md-4 p-b-30">
            <div class="hov-img-zoom">
              <img src="https://i.imgur.com/3RdqlDa.jpg" alt="IMG-ABOUT" />
            </div>
          </div>
